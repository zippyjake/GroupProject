...
public class Cord extends Ronda{
    ...
    public String getDesc(){
        return String.format("Introducing the Cord—a stylish sedan that combines comfort and performance. With its " +
                ...
                "sophisticated choice for those seeking a well-rounded driving experience.",this.getMake(),this.getModel(),this.getTotalCost());//PLACEHOLDER
    }
}
