...
public class ScaleMock extends Meep{
    ...
    public String getDesc(){
        return String.format("Meet the ScaleMock—a tough and versatile pickup truck ready for any adventure. " +
                ...
                " choice for those who want a truck that can handle both work and play with ease.",this.getMake(),
